...
It is also possible to add custom start and end time (in the form of UTC timestamps) to the metadata, so that it will be properly categorized in the Granulate Performance Studio (i.e. `# {"start_time": "2022-10-21 13:51:29.640637","end_time": "2022-10-21 13:54:29.640637", ...`)
