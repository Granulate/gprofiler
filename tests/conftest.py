...
def application_docker_image_configs() -> Mapping[str, Dict[str, Any]]:
    runtime_image_listing: Dict[str, Dict[str, Dict[str, Any]]] = {
        ...
        "nodejs": {
            ...
            "10-glibc": dict(buildargs={"NODE_IMAGE": "node", "NODE_IMAGE_TAG": "10-slim"}),
            "10-musl": dict(buildargs={"NODE_IMAGE": "node", "NODE_IMAGE_TAG": "10.24.1-alpine"}),
            "11-glibc": dict(buildargs={"NODE_IMAGE": "node", "NODE_IMAGE_TAG": "11-slim"}),
            "11-musl": dict(buildargs={"NODE_IMAGE": "node", "NODE_IMAGE_TAG": "11-alpine"}),
            "12-glibc": dict(buildargs={"NODE_IMAGE": "centos/nodejs-12-centos7", "NODE_IMAGE_TAG": "12"}),
            "12-musl": dict(buildargs={"NODE_IMAGE": "node", "NODE_IMAGE_TAG": "12.22.12-alpine"}),
            "13-glibc": dict(buildargs={"NODE_IMAGE": "node", "NODE_IMAGE_TAG": "13-slim"}),
            "13-musl": dict(buildargs={"NODE_IMAGE": "node", "NODE_IMAGE_TAG": "13-alpine"}),
            "14-glibc": dict(buildargs={"NODE_IMAGE": "node", "NODE_IMAGE_TAG": "14-slim"}),
            "14-musl": dict(buildargs={"NODE_IMAGE": "node", "NODE_IMAGE_TAG": "14-alpine"}),
            "15-glibc": dict(buildargs={"NODE_IMAGE": "node", "NODE_IMAGE_TAG": "15-slim"}),
            "15-musl": dict(buildargs={"NODE_IMAGE": "node", "NODE_IMAGE_TAG": "15-alpine"}),
            "16-glibc": dict(buildargs={"NODE_IMAGE": "node", "NODE_IMAGE_TAG": "16-slim"}),
            "16-musl": dict(buildargs={"NODE_IMAGE": "node", "NODE_IMAGE_TAG": "16-alpine"}),
        },
        "php": {
            "": {},
        },
