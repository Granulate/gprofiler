...
def application_docker_image_configs() -> Mapping[str, Dict[str, Any]]:
    runtime_image_listing: Dict[str, Dict[str, Dict[str, Any]]] = {
        ...
        "nodejs": {
            ...
            "10-alpine": dict(dockerfile="matrix.Dockerfile", buildargs={"NODE_IMAGE_TAG": "10.24.1-alpine"}),
            "10-slim": dict(dockerfile="matrix.Dockerfile", buildargs={"NODE_IMAGE_TAG": "10-slim"}),
            "11-alpine": dict(dockerfile="matrix.Dockerfile", buildargs={"NODE_IMAGE_TAG": "11-alpine"}),
            "11-slim": dict(dockerfile="matrix.Dockerfile", buildargs={"NODE_IMAGE_TAG": "11-slim"}),
            "12-alpine": dict(dockerfile="matrix.Dockerfile", buildargs={"NODE_IMAGE_TAG": "12.22.12-alpine"}),
            "12-slim": dict(dockerfile="matrix.Dockerfile", buildargs={"NODE_IMAGE_TAG": "12.22.12-slim"}),
            "13-alpine": dict(dockerfile="matrix.Dockerfile", buildargs={"NODE_IMAGE_TAG": "13-alpine"}),
            "13-slim": dict(dockerfile="matrix.Dockerfile", buildargs={"NODE_IMAGE_TAG": "13-slim"}),
            ...
            "15-alpine": dict(dockerfile="matrix.Dockerfile", buildargs={"NODE_IMAGE_TAG": "15-alpine"}),
            "15-slim": dict(dockerfile="matrix.Dockerfile", buildargs={"NODE_IMAGE_TAG": "15-slim"}),
