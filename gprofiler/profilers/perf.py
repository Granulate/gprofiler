...
class SystemProfiler(ProfilerBase):
    ...
    def start(self) -> None:
        ...
        if self.perf_node_attach:
            ...
            self.pids_without_perf_maps.extend(generate_map_for_node_processes(self._node_processes))
    ...
    def stop(self) -> None:
        if self.perf_node_attach:
            ...
            clean_up_node_maps(self._node_processes, self.pids_without_perf_maps)
