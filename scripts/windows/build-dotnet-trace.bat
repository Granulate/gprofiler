...
for /f "delims=" %%x in (scripts/dotnet_trace_dependencies.txt) do COPY ".\dep\dotnet\shared\Microsoft.NETCore.App\%DOTNET_SHARED_VERSION%\%%i" .\app\gprofiler\resources\dotnet\shared
