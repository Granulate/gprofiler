...
#
# Disabled code block - Not supported on Windows - Alternative required
#import fcntl
# End Edit
import glob
import os
...
class PHPSpyProfiler(ProfilerBase):
    ...
    # Modified dump_signal as signal.SIGUSR2 is not supported on Windows
    #dump_signal = signal.SIGUSR2
    dump_signal = signal.SIGFPE
    # End edit
    ...
    def start(self) -> None:
        ...
        # Disabled code block - Not supported on Windows - Alternative is required
        #fcntl.fcntl(
